...
complete = ['Argentina Primera División', 'Brazil Serie A', 'Finland Veikkausliiga', 'Georgia Erovnuli Liga', 'Japan J2-League', 'Korea K-League 2']
incomplete = ['England Premier League', 'England Championship']
summer = ['Argentina Primera División', 'Brazil Serie A', 'Finland Veikkausliiga', 'Georgia Erovnuli Liga', 'Japan J2-League', 'Korea K-League 2']
